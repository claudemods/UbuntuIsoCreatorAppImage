...
cd /home/$USER/UbuntuIsoCreatorAppImage/cscriptadvanced/all-in-one/ && make
cp /home/$USER/UbuntuIsoCreatorAppImage/cscriptadvanced/all-in-one/ubuntuisocreator.bin /home/$USER/.config/cui/
...
sudo cp UbuntuIsoCreatorAppImage/cscript/cuiadvanced.desktop /usr/share/applications
